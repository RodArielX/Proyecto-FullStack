...
// Paso 4 => Linea 54
    return (
        <>
            <div className="bg-white flex justify-center items-center w-1/2">
                ...
                {Object.keys(mensaje).length>0 && <Mensaje tipo={mensaje.tipo}>{mensaje.respuesta}</Mensaje>}  
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label className="mb-2 block text-sm font-semibold" htmlFor="nombre">Ciudad:</label>
                            <input type="text" id="ciudad" name='ciudad'
                                value={form.ciudad || ""} onChange={handleChange}
                                placeholder="Ingresa tu ciudad" className="block w-full rounded-md border border-gray-300 focus:border-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-700 py-1 px-1.5 text-gray-500" required />
                        </div>
            ...
            <div className="w-1/2 h-screen bg-[url('/images/Logo_Register_DJ.jpeg')] 
